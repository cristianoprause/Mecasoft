...
public class UsuarioDAO extends EclipseLinkConnection implements UsuarioUtils{
	...
	public List<Usuario> findAllByStatus(boolean status) {
		Query q = getEntityManager().createQuery("select u from Usuario u where u.ativo = :status");
